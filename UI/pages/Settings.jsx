        ...
        <div className="details__form">
          ...
          <form>
            <div className="form__group">
              <div>
                <label>Live in</label>
                <input type="text" placeholder="Manipal, India" />
              </div>

              <div>
                <label>Street</label>
                <input type="text" placeholder="Tiger Circle" />
              </div>
            </div>
            ...
            <div className="form__group">
              <div>
                <label>Email</label>
                <input type="email" placeholder="abcdefg@gmail.com" />
              </div>

              <div>
                <label>Phone Number</label>
                <input type="number" placeholder="+91 71*******" />
              </div>
            </div>
